setwd("C:/users/nathanbayless/Desktop/Evolution/Tasks/Task_05")
...
005_plot01.pdf <- par(mar = c(4, 4, 1, 1), las = 1, mgp = c(2, 0.25, 0) tck=0.005, cex.lab=1.25) 
plot(He_lobster, Ho_lobster, xlab = "expected H", ylab = "observed H", pch = 21, bg = "gray", xlim = c(0.32, 0.405), ylim = c(0.32, 0.45))
abline(0, 1, lty = 3 )
...
yes
coalescent.plot(n = 45, ngen = 50, col.order = "alternating")
Populationgraph1 <- coalescent.plot(n = 45, ngen = 50, col.order = "alternating")
Populationgraph2 <- coalescent.plot(n = 13, ngen = 30, col.order = "alternating")
nuc.div(Populationgraph1, Populationgraph2)
Populationgraph1
plot(Populationgraph1)
data(Populationgraph1)
nuc.div(Populationgraph1, variance = FALSE, pairwise.deletion = FALSE)
